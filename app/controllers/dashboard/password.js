...
function cambiarClave() {
    ...
    if (document.getElementById("clave1").value == '') {
        sweetAlert(3, 'Ingrese su nueva contraseña', null, 'Complete todos los campos');
    } else {
        ...
        if (document.getElementById("clave2").value == '') {
            ...
            if (document.getElementById("clave1").value != document.getElementById("clave2").value) {
                sweetAlert(3, 'Las claves ingresadas deben ser iguales', null, 'Las claves no coinciden');
            } else {
                if (document.getElementById("clave2").value != '') {
                    ...
                    sweetAlert(4, 'Ingrese la confirmacíon de la contraseña', null, 'Complete todos los campos');
                }
            }
        }
    }
